...
export const taskModelMatrix: Record<TaskType, TaskRouting> = {
  ...
  // AI integration code generation — routes to Codestral for best TypeScript output
  aiIntegration:  { primary: { provider: "mistral", model: "codestral-latest" },        fallback: [{ provider: "githubModels", model: "codestral-25.01" }, { provider: "githubModels", model: "llama-3.3-70b-instruct" }] },
};
