      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-[380px]">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-xl font-semibold text-sm border border-white/[0.10] bg-white/[0.03] hover:bg-white/[0.07] hover:border-white/[0.18] transition-all group"
          >
